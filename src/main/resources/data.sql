...
INSERT INTO SUBSCRIPTION(SIGNUP_DATE, ID) VALUES (DATE '2024-01-23', 1)
INSERT INTO SUBSCRIPTION_PREMIUM_PERIOD(SUBSCRIPTION_ID, PREMIUM_PERIOD) VALUES (1, CAST((DATE '2023-01-23',DATE '2023-01-25') AS BINARY VARYING))
or just serialize some List<Pair<LocalDate, LocalDate>> in java and save the byte output then try feeding it back to the db using insert
...
INSERT INTO USERX (ENABLED, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, CREATE_USER_USERNAME, CREATE_DATE, FAVORITE_DATA_CONFIG_ID) VALUES(TRUE, 'Susi', 'Kaufgern', '$2a$10$4ENBx/wSbkRKzj9D5vcnjuif.QpkahXzSNyxi9Ki9Na8O/A/M.HDy', 'user1', 'admin', '2016-01-01 00:00:00', '222222')
...
INSERT INTO USERX (ENABLED, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, CREATE_USER_USERNAME, CREATE_DATE, FAVORITE_DATA_CONFIG_ID) VALUES(TRUE, 'Max', 'Mustermann', '$2a$10$4ENBx/wSbkRKzj9D5vcnjuif.QpkahXzSNyxi9Ki9Na8O/A/M.HDy', 'user2', 'admin', '2016-01-01 00:00:00', '333333')
...
INSERT INTO USERX (ENABLED, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, CREATE_USER_USERNAME, CREATE_DATE, FAVORITE_DATA_CONFIG_ID, SUBSCRIPTION_ID) VALUES(TRUE, 'Prem', 'Mium', '$2a$10$4ENBx/wSbkRKzj9D5vcnjuif.QpkahXzSNyxi9Ki9Na8O/A/M.HDy', 'premium1', 'admin', '2016-01-01 00:00:00', '555555', 1)
