 ...
 *
 * @param timestamp UNIX timestamp, use timezone or timezoneOffset from parent to convert to {@link
 *     java.time.ZonedDateTime}
 * @param sunrise UNIX timestamp, use timezone or timezoneOffset from parent to convert to {@link
 *     java.time.ZonedDateTime}
 * @param sunset UNIX timestamp, use timezone or timezoneOffset from parent to convert to {@link
 *     java.time.ZonedDateTime}
 ...
 * @param dewPoint atmospheric temperature below which water droplets begin to condense in deg
 *     celsius
