 ...
 * <br>
 * Strangely the weather structure is always wrapped in a collection in the result json. This
 * deserializer takes care of that and extracts the value of the collection into a single object
 */
