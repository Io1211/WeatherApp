 ...
 *
 * @param timestamp UNIX timestamp in UTC, use timezone/timezone offset create {@link
 *     java.time.ZonedDateTime}
 * @param precipitation in mm/h
 * @see <a href="https://openweathermap.org/api/one-call-3#current">API Documentation</a>
 */
public record PrecipitationByTimestampDTO(
    @JsonProperty("dt") Instant timestamp, double precipitation) implements Serializable {
